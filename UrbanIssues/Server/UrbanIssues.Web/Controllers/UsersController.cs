namespace UrbanIssues.Web.Controllers
{
    ...
    using UrbanIssues.Web.Models.Users;
    using UrbanIssues.Web.Providers;
    using UrbanIssues.Web.Results;
    ...
    public class UsersController : BaseApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
			if (model == null)
			{
				return this.BadRequest("User cannot be null or empty");
			}
